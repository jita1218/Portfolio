...
import headingFontLatest from '../font/orbitron-v29-latin-800.woff2';
import headingFontBackup from '../font/orbitron-v29-latin-800.ttf';
...
export default function SplashSection({ splashMessage, isDarkMode, isErrorMode }) {
    return (
        <div className="splash">
            ...
            <canvas id="splash-intro" className="w-[100%] mt-3" aria-label={`Interactive particle animation that displays text ${splashMessage}`} role="img">
